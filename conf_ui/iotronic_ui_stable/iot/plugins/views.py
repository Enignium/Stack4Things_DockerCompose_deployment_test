...
class RemoveFromFleetsView(forms.ModalFormView):
    template_name = 'iot/plugins/remove_fleet.html'
    ...
    submit_url = "horizon:iot:plugins:remove_fleet"
    success_url = reverse_lazy('horizon:iot:plugins:index')
