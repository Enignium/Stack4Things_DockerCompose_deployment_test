...
class InjectFleetPluginLink(tables.LinkAction):
    ...
    url = "horizon:iot:plugins:inject_fleet"
    classes = ("ajax-modal",)
    icon = "plus"
...
class RemovePluginFromFleetsLink(tables.LinkAction):
    ...
    url = "horizon:iot:plugins:remove_fleet"
...
class PluginsTable(tables.DataTable):
    ...
    class Meta(object):
        ...
        row_actions = (EditPluginLink, InjectPluginLink,InjectFleetPluginLink, StartPluginLink,
                       StopPluginLink, CallPluginLink, RemovePluginLink, RemovePluginFromFleetsLink, DeletePluginsAction,)
