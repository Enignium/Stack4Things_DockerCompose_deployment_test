...
class CreatePluginLink(tables.LinkAction):
    ...
    url = "horizon:iot:fleets_plugins:create"
    classes = ("ajax-modal",)
    icon = "plus"
...
class EditPluginLink(tables.LinkAction):
    name = "edit"
    verbose_name = _("Edit")
    url = "horizon:iot:fleets_plugins:update"
    classes = ("ajax-modal",)
    icon = "pencil"
...
class InjectPluginLink(tables.LinkAction):
    ...
    url = "horizon:iot:fleets_plugins:inject"
    classes = ("ajax-modal",)
    icon = "plus"
...
class InjectFleetPluginLink(tables.LinkAction):
    name = "inject_fleet"
    verbose_name = _("Inject Plugin to Fleet")
    url = "horizon:iot:fleets_plugins:inject_fleet"
    classes = ("ajax-modal",)
    icon = "plus"

class RemovePluginFromFleetsLink(tables.LinkAction):
    name = "remove_plugin_fleet"
    verbose_name = _("Remove Plugin from Fleet(s)")
    url = "horizon:iot:fleets_plugins:remove_fleet"
...
class StartPluginLink(tables.LinkAction):
    ...
    url = "horizon:iot:fleets_plugins:start"
    classes = ("ajax-modal",)
    icon = "plus"
...
class StopPluginLink(tables.LinkAction):
    ...
    url = "horizon:iot:fleets_plugins:stop"
    classes = ("ajax-modal",)
    icon = "plus"
...
class CallPluginLink(tables.LinkAction):
    ...
    url = "horizon:iot:fleets_plugins:call"
    classes = ("ajax-modal",)
    icon = "plus"
...
class RemovePluginLink(tables.LinkAction):
    ...
    url = "horizon:iot:fleets_plugins:remove"
    classes = ("ajax-modal",)
    icon = "plus"
...
class PluginsTable(tables.DataTable):
    name = tables.WrappingColumn('name', link="horizon:iot:fleets_plugins:detail",
    ...
    def get_row_actions(self, datum):
        ...
        common_actions = ["edit", "inject","inject_fleet", "remove", "delete"]
    ...
    class Meta(object):
        ...
        row_actions = (EditPluginLink,InjectFleetPluginLink, StartPluginLink,
                       StopPluginLink, CallPluginLink, RemovePluginFromFleetsLink, DeletePluginsAction,)
