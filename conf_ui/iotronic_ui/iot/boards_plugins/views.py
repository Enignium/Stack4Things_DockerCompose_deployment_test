...
from iotronic_ui.iot.boards_plugins import forms as project_forms
from iotronic_ui.iot.boards_plugins import tables as project_tables
from iotronic_ui.iot.boards_plugins import tabs as project_tabs
...
class IndexView(tables.DataTableView):
    ...
    template_name = 'iot/boards_plugins/index.html'
...
class CreateView(forms.ModalFormView):
    template_name = 'iot/boards_plugins/create.html'
    ...
    submit_url = reverse_lazy("horizon:iot:boards_plugins:create")
    success_url = reverse_lazy('horizon:iot:boards_plugins:index')
    page_title = _("Create Plugin")


class InjectView(forms.ModalFormView):
    template_name = 'iot/boards_plugins/inject.html'
    ...
    submit_url = "horizon:iot:boards_plugins:inject"
    success_url = reverse_lazy('horizon:iot:boards_plugins:index')
    ...
    def get_object(self):
        try:
            ...
            redirect = reverse("horizon:iot:boards_plugins:index")
            exceptions.handle(self.request,
...
class RemoveFromFleetsView(forms.ModalFormView):
    template_name = 'iot/boards_plugins/remove_fleet.html'
    ...
    submit_url = "horizon:iot:boards_plugins:remove_fleet"
    success_url = reverse_lazy('horizon:iot:boards_plugins:index')
...
class StartView(forms.ModalFormView):
    template_name = 'iot/boards_plugins/start.html'
    ...
    submit_url = "horizon:iot:boards_plugins:start"
    success_url = reverse_lazy('horizon:iot:boards_plugins:index')
...
class StopView(forms.ModalFormView):
    template_name = 'iot/boards_plugins/stop.html'
    ...
    submit_url = "horizon:iot:boards_plugins:stop"
    success_url = reverse_lazy('horizon:iot:boards_plugins:index')
...
class CallView(forms.ModalFormView):
    template_name = 'iot/boards_plugins/call.html'
    ...
    submit_url = "horizon:iot:boards_plugins:call"
    success_url = reverse_lazy('horizon:iot:boards_plugins:index')
...
class RemoveView(forms.ModalFormView):
    template_name = 'iot/boards_plugins/remove.html'
    ...
    submit_url = "horizon:iot:boards_plugins:remove"
    success_url = reverse_lazy('horizon:iot:boards_plugins:index')
...
class UpdateView(forms.ModalFormView):
    template_name = 'iot/boards_plugins/update.html'
    ...
    submit_url = "horizon:iot:boards_plugins:update"
    success_url = reverse_lazy('horizon:iot:boards_plugins:index')
...
class PluginDetailView(DetailView):
    redirect_url = 'horizon:iot:boards_plugins:index'
