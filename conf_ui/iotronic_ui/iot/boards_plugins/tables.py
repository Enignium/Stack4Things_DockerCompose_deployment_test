...
class CreatePluginLink(tables.LinkAction):
    ...
    url = "horizon:iot:boards_plugins:create"
    classes = ("ajax-modal",)
    icon = "plus"
...
class EditPluginLink(tables.LinkAction):
    name = "edit"
    verbose_name = _("Edit")
    url = "horizon:iot:boards_plugins:update"
    classes = ("ajax-modal",)
    icon = "pencil"
...
class InjectPluginLink(tables.LinkAction):
    ...
    url = "horizon:iot:boards_plugins:inject"
    classes = ("ajax-modal",)
    icon = "plus"
...
class StartPluginLink(tables.LinkAction):
    ...
    url = "horizon:iot:boards_plugins:start"
    classes = ("ajax-modal",)
    icon = "plus"
...
class StopPluginLink(tables.LinkAction):
    ...
    url = "horizon:iot:boards_plugins:stop"
    classes = ("ajax-modal",)
    icon = "plus"
...
class CallPluginLink(tables.LinkAction):
    ...
    url = "horizon:iot:boards_plugins:call"
    classes = ("ajax-modal",)
    icon = "plus"
...
class RemovePluginLink(tables.LinkAction):
    ...
    url = "horizon:iot:boards_plugins:remove"
    classes = ("ajax-modal",)
    icon = "plus"
...
class PluginsTable(tables.DataTable):
    name = tables.WrappingColumn('name', link="horizon:iot:boards_plugins:detail",
    ...
    class Meta(object):
        ...
        row_actions = (EditPluginLink, InjectPluginLink, StartPluginLink,
                       StopPluginLink, CallPluginLink, RemovePluginLink, DeletePluginsAction,)
